...
public class QuestionEnterpriseDetailAction implements CommandAction {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		QuestionDataBean article = dbPro.getEnterpriseArticle(num); // 해당 글번호에 대한 해당 레코드
		...
		return "/Question/questionEnterpriseDetail.jsp";
	}
}
