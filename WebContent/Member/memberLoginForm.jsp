...
<script language="javascript">
	...
	function searchId() {
		...
		url = "/Kkuni/Member/SearchIdForm.do";
	...
	function searchPw() {
		url = "/Kkuni/Member/SearchPwForm.do";
		window.open(url, "post", "toolbar=no, left=770%, top=400%, width=435, height=200, directories=no, status=yes, scrollbars=yes, menubar=no");
	}
</script>
</head>
...
<form method="post" name="userinput" action="/Kkuni/Member/LoginPro.do" onsubmit="return checkIt()">
...
<br><br>
	...
	<table>
		<tr>
		<td><br><label>아이디 &emsp;&emsp;<input type="text" name="userid"></label><td>
		<td rowspan=2><input type="submit" id="login" class="btn_p" value="로그인"></td>
		</tr>
		<tr>
		<td><label>비밀번호  &emsp;<input type="password" name="userpwd"></label></td>
		</tr>
		<tr>
		<td colspan=4>
			&emsp;&emsp;
			...
			<input type="button" class="bt" value="회원가입" onclick="document.location.href='/Kkuni/Member/InsertForm.do'">
		</td>
		</tr>
	</table>
	</div>
