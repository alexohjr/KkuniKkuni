...
<div style="background-color: white; width: 1680x; min-height: 900px; margin: 10px; margin: 80px 0px 0px 200px;">
	<div style="width:1500px; position: absolute; left: 300px; " >
			...
			<div align="right">
				<input class="btn_p" type="button" value="수정" onclick="document.location.href='/Kkuni/Notice/UpdateForm.do?noticeNo=${article.noticeNo}&pageNum=${pageNum}'">
				<input class="btn_b" type="button" value="목록" onclick="document.location.href='/Kkuni/Notice/NoticeAdminList.do?pageNum=${pageNum}'">
			</div>
	</div>
</div>
</body>
