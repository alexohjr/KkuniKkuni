	...
	<div style="width:1500px; position: absolute; left: 300px; " >
			...
			<table width="1500" border=1 cellpadding="0" cellspacing="0" align="center">
				...
				<tr>
					...
					<td colspan="10">
					<input type="file" name="nFile" accept="image/gif, image/jpeg, image/png"/>${article.nFile}</td>
					<input type="hidden" name="nFileog" value="${article.nFile }">
					<input type="hidden" name="nRealpathog" value="${article.nRealpath }">
				</tr>
				<tr>
					<td colspan="10">
