...
<body>
	...
	<div class="total">
		...
		<div class="wrapper">
			...
			<form method="post" action="/Kkuni/Question/ServiceDelete.do?questionNo=${article.questionNo}&pageNum=${pageNum}" style="width: 1200px; margin-left: 10px;" onsubmit="return delete_check()">
						...
						<table style="border: 1px solid #e4e4e4; margin-left: 0px;" width="1150" align="center">
							<form method="post">
								...
								<tr class="trqu">
									...
									<div cols=130 name="aContents" rows=5 style="resize: none; border: none;" readonly="readonly">
									${articleAnswer.aContents}
									</div></td>
								</tr>
						</table>
				</c:if>
